...
| 메뉴     | menu             | - 사장님이 등록 후 손님이 주문할 수 있는 단위이며, 한 개 이상 상품으로 구성된다.                                                                                                                                                                                                    |
| 메뉴 노출  | menu display     | - 손님이 메뉴에 대한 정보를 볼 수 있다는 것을 의미한다.                                                                                                                                                                                                                   |
...
| 숨겨진 메뉴 | undisplayed menu | - 노출되어 있지 않은 메뉴.                                                                                                                                                                                                                                    |
| 배달 대행사 | delivery rider   | - 배달 주소로 메뉴를 전달해주는 대행사.<br>- 배달 대행사 수락이 안되는 경우, 배달 접수가 안된다.                                                                                                                                                                                         |
| 주문 상태  | order status     | - 주문 접수(WAITING), 주문 수락(ACCEPTED), 서빙 완료(SERVED), 배달 중(DELIVERING), 배달 완료(DELIVERED), 주문 완료(COMPLETED)<br>- 배달 주문: 주문 접수 → 주문 수락 → 서빙 완료 → 배달 중 → 배달 완료 → 주문 완료<br>- 포장 주문: 주문 접수 → 주문 수락 → 서빙 완료 → 주문 완료<br>- 매장 주문: 주문 접수 → 주문 수락 → 서빙 완료 → 주문 완료 |
| 서빙 완료  | served           | - 배달과 포장의 경우 음식 조리 및 포장까지 완료된 상태를 말한다.<br>- 매장 주문의 경우 음식 조리가 끝나 손님에게 전달할 수 있는 상태를 말한다.                                                                                                                                                              |
